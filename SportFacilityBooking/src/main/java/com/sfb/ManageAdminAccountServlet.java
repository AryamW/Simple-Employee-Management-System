...
/**
 * Servlet implementation class ManageAdminAccountServlet
 */
public class ManageAdminAccountServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user_id!=0) {
		 try{	
	            ...
	            RequestDispatcher rd = request.getRequestDispatcher("/admin/manageAdminAccount.jsp");
